...
# Adapted for {{PROJECT_NAME}} -- stores observations in .opencode/learning/observations/
#
# Hook config (in ~/.claude/settings.json or project .claude/settings.json):
# {
#   "hooks": {
#     "PreToolUse": [{
#       "matcher": "*",
#       "hooks": [{ "type": "command", "command": ".opencode/skills/continuous-learning-v2/hooks/observe.sh pre" }]
#     }],
#     "PostToolUse": [{
#       "matcher": "*",
#       "hooks": [{ "type": "command", "command": ".opencode/skills/continuous-learning-v2/hooks/observe.sh post" }]
#     }]
#   }
# }
...
# Use project-local learning directory (gitignored)
PROJECT_DIR="$(git rev-parse --show-toplevel 2>/dev/null || pwd)"
CONFIG_DIR="${PROJECT_DIR}/.opencode/learning/observations"
